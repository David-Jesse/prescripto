...
const Login = () => {
    ...
    const {token, backendUrl, setToken} = useAppContext();
            ...
            <div
                ...
                <p>Please {state === 'Sign Up' ? 'sign up' : 'login'} to book an appointment </p>
                {
                    state === 'Sign Up' && <div className={'w-full'}>
                        <p>Full Name</p>
                        <input
                            className={'border border-zinc-300 outline-none rounded focus:outline-[#5f6fff] w-full p-2 mt-1'}
                            type="text"
                ...
                <div className={'w-full'}>
                    <p>Email</p>
                    <input
                        className={'border border-zinc-300 outline-none focus:outline-[#5f6fff] rounded w-full p-2 mt-1'}
                        type="email"
                ...
                <div className={'w-full'}>
                    <p>Password</p>
                    <input
                        className={'border border-zinc-300 rounded outline-none focus:border-[#5f6fff] w-full p-2 mt-1'}
                        type="password"
